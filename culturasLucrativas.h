...
#define INVERVALO_MUTACAO       0.05  // Chance de uma mutação acontecer
#define LIMITE_GERACAO          1000   // Limite de gerações para finalizar o Algoritmo
#define LIMITE_LUCRO            500   // Limite de lucro que finaliza o algoritmo
